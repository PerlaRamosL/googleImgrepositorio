...
<body style="background-color: #343a40;color: white">
      <div class="container">
          ...
          <h2>Los dioses griegos, adorados por los antiguos habitantes de Grecia, eran representados bajo la forma humana, y simbolizan los anhelos y temores humanos.<br></h2>
	        
	        <!--
          <ul class="gridder">
	        	<li class="gridder-list" data-griddercontent="#gridder-content-0">
                <img src="img/afrodita.jpg">
                </li>
            </ul>
            <div id="gridder-content-0" class="gridder-content">
            <div class="row">
            <div class="col-sm-6">
            <img src="img/afrodita.jpg" class="img-responsive">	
            </div>
            <div class="col-sm-6"> 
            <h2>Afrodita</h2>
